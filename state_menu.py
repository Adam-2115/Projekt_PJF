...
class MenuState:
    def __init__(self, ctx):
        ...
        self.btns = {
            "potyczka": Button("POTYCZKA", bx, SCREEN_HEIGHT//2 - 130, bw, bh),
            "misje":    Button("MISJE", bx, SCREEN_HEIGHT//2 - 70, bw, bh),
            "multi":    Button("MULTIPLAYER", bx, SCREEN_HEIGHT//2 - 10, bw, bh),
